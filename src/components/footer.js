...
const Footer = () => {
  ...
  return (
    <>
      <section className='bg-[#F8F8F8] pt-7 '>
        <footer className='  w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto'>
          ...
          <div className='grid grid-cols-2 gap-6 mb-10 md:grid-cols-4 lg:grid-cols-5'>
            <div className='hidden col-span-full lg:col-span-1 lg:block'>
              ...
              <p className='mt-3 text-base font-bold text-[#132758]   dark:text-gray-400'>
            ...
            {links.map((item, i) => (
              <div key={i}>
                <h4 className='text-base mb-5 font-bold text-[#132758]  uppercase '>
                  {item.name}
                </h4>
                <div className='grid mt-3 space-y-3 text-sm'>
                  {item.menu.map((link, i) => (
                    <p key={link + i}>
                      <Link
                        className='inline-flex text-[#132758]  gap-x-2 hover:text-gray-800 '
                        href={link.link}
                      >
                        {link.text}
                      </Link>
            ...
            <div className='sm:flex sm:justify-between sm:items-center'>
              <div className='flex items-center gap-x-3'>
                <div className='space-x-4 text-sm '>
                  <a
                    className='inline-flex text-[#132758] gap-x-2 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200'
                    href='#'
                  >
                    Terms
                  </a>
