...
const Hero = () => {
  return (
    <div className="bg-[#4874FF] h-auto pb-16 md:pb-20 lg:pb-28 hero-bg">
      <div className="blur-bg">
      <Image src={blurBg} alt=""/>
      </div>
      <Navbar />

      <div className="w-full md:w-5/6 m-auto mt-20 md:mt-32 relative z-10 pl-4 pr-4 md:pl-0 md:pr-0">
        ...
        <ul className="flex items-center text-white font-medium mt-2 mb-4">
          ...
          <li className="text-xs md:text-sm lg:text-base flex md:mr-6 items-center">
            <BsCheckLg className="mr-1 md:mr-2"/> Exceptional Network Performance
          </li>
        </ul>
        ...
        <div className="mt-8 md:mt-10 lg:mt-16 bg-white py-4 px-3 rounded-md">
            <form action="" className="md:flex items-center justify-between" >
                <input type="text" name="" id="" placeholder="WISP Name" className="bg-[#F9FAFB] p-2 md:p-3 rounded-md md:mr-3 lg:mr-6 text-[10px] md:text-xs lg:text-sm w-full mb-4 md:mb-0"/>
                <input type="number" name="" id="" placeholder="Number of Towers" className="bg-[#F9FAFB] p-2 md:p-3 rounded-md mr-2 md:mr-3 lg:mr-6 text-[10px] md:text-xs lg:text-sm w-full mb-4 md:mb-0"/>
                <input type="email" name="" id="" placeholder="Email" className="bg-[#F9FAFB] p-2 md:p-3 rounded-md md:mr-3 lg:mr-6 text-[10px] md:text-xs lg:text-sm w-full mb-4 md:mb-0"/>
                <button type="submit" className="bg-[#4874FF] text-[10px] md:text-xs lg:text-sm py-2 md:py-3 px-3 md:px-4 text-white rounded-md block m-auto">Subscribe</button>
            </form>
        </div>
      </div>
    </div>
