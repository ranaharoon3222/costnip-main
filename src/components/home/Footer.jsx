...
const Footer = () => {
  return (
    <div className="bg-primary">
        ...
        <div className="footer-border lg:flex justify-between pt-7 lg:pt-10">
          <div>
            <Image
              src={logo}
              alt=""
              className="w-[130px] block lg:inline-block m-auto lg:m-auto"
            />
          </div>
      ...
      <p className="text-[#F4F7FF] leading-6 text-xs lg:text-sm text-center py-3 tracking-tight mt-1">
        Copyright 2023 IsoHorns LLC. All Rights Reserved
      </p>
      <div></div>
    </div>
  );
